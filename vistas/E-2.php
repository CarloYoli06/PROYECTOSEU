...
<div class="text-warning-emphasis d-flex justify-content-between align-items-center" containe style="background-color:white">
        ...
        <div class="contenido">
              <div class="area_inscripciones">
                ...
                <div class="tarjetas_de_actividades">
                    ...
                    $sql=$conexion->query("select*from alumnos al inner join alumnos_actividad aa on(al.noCtrl=aa.noCtrl)inner join actividad a on(a.id_ACTIVIDAD=aa.id_EVENTO) WHERE al.noCtrl = '$id_usuario'");
                    ...
                    <div class="tarjeta3">
                        ...
                        <button type="button" class="btn_info2"  onclick="mensaje2('<?= $datos->id_ACTIVIDAD ?>')" >
                            ...
                            <h4 class="texto_btn">Información</h4>
                        </button>
                        </div>
                        <div>
                        <button type="button" data-bs-toggle="modal" data-bs-target="#modalqr"  >
                            <h4 class="texto_btn">Registrar Asistencia</h4>
                        </button>
                     </div>
            ...
            <div class="area_actividadesProximas">
                ...
                <div class="tarjetas_de_actividades">
                    <?php
                    include "C:/xampp/htdocs/ProyectoSEU/control/conexion.php";
                    $sql=$conexion->query("select*from actividad where id_ACTIVIDAD NOT IN(select id_EVENTO from alumnos_actividad where noCtrl='$id_usuario')
                        and curdate()<HORARIO");
                    while ($datos=$sql->fetch_object()) {
                         // code...
                    ...
                    <div class="tarjeta3">
                        <div class="fondo1" style="--src:url(../assets/warm_orange_abstract.png)">
                         ...
                         <h4 class="texto_btn2">Inscribirse</h4>   
                        </input>
                    </div>
                    <?php } ?>
            ...
            <div class="area_actividadesProximas">
                ...
                <div class="tarjetas_de_actividades">
                    <?php
                    include "C:/xampp/htdocs/ProyectoSEU/control/conexion.php";
                    $sql=$conexion->query("select*from evento where curdate()<FIN");
                    while ($datos=$sql->fetch_object()) {
                         // code...
    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <div class="asistir">
                <button type="button" class="btn btn-primary btn-lg boton_personalizado" id="btnDesinscribirse" onclick="desinscribir('<?php echo $id_usuario;?>',ida)">Desinscribirse</button>
...
<div class="modal modal_prin" id="myModal2" tabindex="-1" style="max-width: 1800px; max-height: 800px;">
    <div class="modal-dialog">
        <div class="modal-content ">
            <div class="modal-header header_modal" >
                <h5 class="modal-title titulo_actividad text-center"><span id="tituloEvento"></span></h5>
            ...
            <div class="modal-body">
                <div class="modal_contenedor">
                    ...
                    <div class="elemento_contenedor2"> 
                        <span id="nombreEvento2" style="font-size: 28px;font-weight:bold;"></span></li>
                        <span id="descripcionEvento2" style="font-size: 18px;"></span>
                            
                        <ul>
                            <li>Lugar: <span id="lugarEvento2"></span></li>
                            <li>Fecha: <span id="fechaEvento2"></span></li>
                            <li>Horario: <span id="horarioEvento2"></span></li>
                            <li>Capacidad: <span id="capacidadEvento2"></span></li>
                            <li>Inscritos: <span id="inscritosEvento2"></span></li>
                            <li>Carrera: <span id="carreraEvento2"></span></li>
                        </ul>
                        <div class="contenedor_infoexpositor">
                            <p class="cont">Contacto:</p>
                            <div class="expo_colum">
                                <div class="colum">
                                    <p class="colum_cont">Telefono:</p>
                                    <p class="colum_cont" id="telefonoEvento2"></p>
                                </div >
                                <div class="colum">
                                    <p class="colum_cont">Facebook:</p>
                                    <p class="colum_cont" id="facebookEvento2"></p>
                                </div>
                                <div class="colum">
                                    <p class="colum_cont">Instagram:<span id="carreraEvento"></span></p>
                                    <p class="colum_cont" id="instagramEvento2"></p>
                                </div>
                                <div class="colum">
                                    <p class="colum_cont">LinkedIn:<span id="carreraEvento"></span></p>
                                    <p class="colum_cont" id="linkedinEvento2"></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="asistir">
                <button type="button" class="btn btn-primary btn-lg boton_personalizado" onclick="inscribir('<?php echo $id_usuario;?>',ida)">Inscribirse</button>
            </div>
            <div id="alerta"></div>
            <div class="modal-footer footer_ventana">
                <p> </p>
...
function desinscribir(nc,id){
    var ruta="nc2="+nc+"&id2="+id;
            $.ajax({
                url: '/ProyectoSEU/control/D112.php',
                type: 'GET',
                data: ruta,
            })
            .done(function(res){
                window.location.href='E-2.php'
            })
            .fail(function(){
                console.log("error");
            })
...
function inscribir(nc,id){
    var ruta="nc="+nc+"&id1="+id;
            $.ajax({
                url: '/ProyectoSEU/control/D112.php',
                type: 'GET',
                data: ruta,
...
function mensaje(n) { 
        ...
        success: function(response) {
            ...
            $('#nombreEvento2').text(data.NOMBRE); // Accede a 'data.NOMBRE'
            $('#lugarEvento2').text(data.LUGAR); // Accede a 'data.DESCRIPCION'
            $('#descripcionEvento2').text(data.DESCRIPCION); // Accede a 'data.DESCRIPCION'
            $('#fechaEvento2').text(data.HORARIO);
            $('#capacidadEvento2').text(data.CAPACIDAD);
            $('#carreraEvento2').text(data.CARRERA);
            $('#nombre_expositor2').text(data.NOMEX);
            $('#instagramEvento2').text(data.INS);
            $('#telefonoEvento2').text(data.TEL);
            $('#linkedinEvento2').text(data.LINK);
            $('#facebookEvento2').text(data.FACE);
            $('#inscritosEvento2').text(data.INSC);
...
function mensaje2(n) {  
        ...
        success: function(response) {
            ...
            $('#tituloEvento').text(data.NOMBRE); // Accede a 'data.NOMBRE'
            $('#lugarEvento').text(data.LUGAR); // Accede a 'data.DESCRIPCION'
            $('#descripcionEvento').text(data.DESCRIPCION); // Accede a 'data.DESCRIPCION'
            $('#fechaEvento').text(data.HORARIO);
            $('#capacidadEvento').text(data.CAPACIDAD);
            $('#carreraEvento').text(data.CARRERA);
            $('#nombre_expositor').text(data.NOMEX);
            $('#instagramEvento').text(data.INS);
            $('#telefonoEvento').text(data.TEL);
            $('#linkedinEvento').text(data.LINK);
            $('#facebookEvento').text(data.FACE);
            $('#inscritosEvento').text(data.INSC);
            $('#myModal').modal('show');
        ...
        function noti(id) {
            ...
            $.ajax({
                url: '/ProyectoSEU/control/backModal2.php',
                type: 'GET',
                data: ruta,
            })
            .done(function(res){
