...
<div class="funciones">
    ...
    <button type="button" name="crear_evento" id="crear_evento" class="btn btn-lg boton_personalizado btn-primary " style="height: 60px; margin-left: 25%" >Guardar Cambios</button>
    <button type="button" name="crear_evento" id="crear_evento" class="btn btn-lg boton_personalizado btn-primary " style="height: 60px; margin-left: 25%" onclick="window.location.href='A-02.1.php';">Cancelar Cambios</button>
