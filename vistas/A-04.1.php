...
<head>
    ...
    <title>Escanear Actividad</title>
...
<form action="../control/ExportarCsv2.php?campo=<?php echo $_GET['act'];?>" method="post">
<div class="funciones">
