...
<script>
    $(buscar('',''));
    function buscar(act,car){
        var ruta="a="+act+"&c="+car;
        $.ajax({
                url: '../control/backA4.php',
                type: 'GET',
                data: ruta,
            })
            .done(function(res){
...
<div class="funciones" style="margin: 0 auto;">
    ...
    <nav class="navbar bus">
        ...
        <form class="form-inline">
            <input class="form-control mr-sm-2" type="text" placeholder="" aria-label="Search" style="width: 400px;" id="txt1">
    ...
    <nav class="navbar bus">
        ...
        <form class="form-inline">
            <input class="form-control mr-sm-2" type="text" placeholder="" aria-label="Search" style="width: 400px;" id="txt2">
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Buscar</button>
        </form>
    </nav>
